...
function imprimirExtrato(){
    ...
    arrDespesas.forEach((gasto) => {
        ...
        if (gasto.tipo==="utilidades") {
            gastoUtilidades += gasto.valor
        }
        if (gasto.tipo==="viagem") {
...
function filtrarDespesas(){
    ...
    let despesasFiltradas = arrDespesas.filter((gasto) => {
        if(gasto.tipo === tipoFiltro || tipoFiltro !== "todos" && gasto.valor <= valorMax && gasto >= valorMin) {
            return true
        }
        if(tipoFiltro === "todos" && gasto.valor <=valorMax && gasto.valor >= valorMin) {
            return true
        }
